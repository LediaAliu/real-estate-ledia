"""
Django settings for property_advisors project.
...
EMAIL_HOST= os.environ.get("EMAIL_HOST", "lediaaliu.gmail.com")
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "propertyadvisors@gmail.com")
